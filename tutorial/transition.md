...
*  **句型公式** ：
    ...
    2. `句子A; 連接副詞, 句子B.`
*  **範例句子** ：
    1. The weather was bad.  **However** , we decided to go out. (對應公式 1)
    2. The weather was bad;  **however** , we decided to go out. (對應公式 2)

### 2. 從屬連接詞 (Subordinating Conjunctions)
*  **常見字眼** ： *Although, Whereas, Because, While*
*  **句型公式** ：
    1. `連接詞 + 句子A, 句子B.`
    2. `句子B + 連接詞 + 句子A.` (中間無逗號)
*  **範例句子** ：
    1.  **Although**  the weather was bad, we decided to go out. (對應公式 1)
    2. We decided to go out  **although**  the weather was bad. (對應公式 2)

### 3. 介系詞片語 (Prepositions)
*  **常見字眼** ： *Despite, In spite of, In addition to, Because of*
*  **句型公式** ：
    1. `介系詞 + 名詞/動名詞, 句子B.`
    2. `句子B + 介系詞 + 名詞/動名詞.`
*  **範例句子** ：
    1.  **Despite**  the bad weather, we decided to go out. (對應公式 1)
    2. We decided to go out  **despite**  the bad weather. (對應公式 2)
...
*  **Instead of** : 而不是
  ...
  *  **例句** :  **Instead of**  ordering takeout, we decided to cook dinner ourselves.
